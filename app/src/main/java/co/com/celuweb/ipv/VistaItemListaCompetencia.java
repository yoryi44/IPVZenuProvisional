...
public class VistaItemListaCompetencia extends LinearLayout {
    ...
    public VistaItemListaCompetencia(Context context) {
    ...
    private void init(Context context) {
        ...
        rootView = inflate(context, R.layout.list_item_lista_productos_competencia_exhibidor, this);
